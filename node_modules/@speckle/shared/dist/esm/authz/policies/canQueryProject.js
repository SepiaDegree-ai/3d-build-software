import { requireAnyWorkspaceRole, requireMinimumWorkspaceRole } from '../checks/workspaceRole.js';
import { authorized, unauthorized } from '../domain/authResult.js';
import { requireExactProjectVisibilityFactory, requireMinimumProjectRoleFactory } from '../checks/projects.js';
...
export const canQueryProjectPolicyFactory = (loaders) => async ({ userId, projectId }) => {
    ...
    if (!project)
        return unauthorized(ProjectNotFoundError);
